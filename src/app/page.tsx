          ...
          <div className="mx-auto max-w-6xl px-5 py-24">
            ...
            <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                ["💸", "Get paid on time", "Kept flags overdue invoices and hands you a one-click chase email — money in, awkward phone calls out."],
                ...
                ["📅", "Appointments & calendar sync", "Book a date on any lead and it syncs to Google, Apple or Outlook automatically — subscribe once, done forever."],
              ...
              {[
                ...
                },
                {
                  ...
                  features: [
                    ...
                    "Quarterly VAT / tax summary",
                    "Webhook / Zapier — connect 5,000+ apps",
